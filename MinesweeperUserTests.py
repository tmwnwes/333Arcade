...
keys = ["Board is created", "Help Menu Appears", "Flag Toggling works", "Bombs make you fail", "Sizing is differnt based on difficulty", "Numbers fit in squares", ]
questions1 = ["Click on a Difficulty Button", "Press H", "Close help screen and click anywhere randomly on the board. Then, on a square that is still green, right click", "Continue playing until you hit a bomb and fail (If you win, try again until you fail)", "Follow the return to menu instructions and select a different difficulty", "Play the game and look at the sizing and location of the numbers in all difficulty options"]
questions2 = ["Was a board created?", "Did a help screen appear", "Did a flag appear", "Did you fail?", "Are the squares a different size, and have a different amount of them?", "Click Yes on this window if all numbers stayed within the bounds of their squares"]
answers = []
