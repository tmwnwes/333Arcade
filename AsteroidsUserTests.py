...
keys = ["W Moves Up", "A Moves Left", "S Moves Down", "D Moves Right", "Left Rotates Left", "Right Rotates Right", "Spacebar Shoots", "Shots Hit", "Asteroids Can Be Destroyed", "Scores Appear", "Damage Is Taken", "Pausing Works", "Shots Fire In Faced Direction", "WASD Keys Move Relative To Rotation"]
questions1 = ["Press and Hold W key", "Press and Hold the A key", "Press and Hold S Key", "Press and Hold D key" , "Press and Hold Left Arrow key", "Press and Hold Right Arrow key", "Press and Hold spacebar", "Continue Firing until your shots collide with an Asteroid", "Continue Firing", "Destroy an Asteroid", "Purposefully drive your ship into an Asteroid", "While alive (not game over screen), Press P key", "Unpause the Game/Play Again. Rotate Your Ship and use WASD to Move"]
questions2 = ["Did you move Up", "Did you move Left", "Did you move Down", "Did you move Right" , "Did you rotate Left", "Did you rotate Right", "Did you shoot", "Did the shots dissappear on contact", "Were any Asteroids destroyed (Larger Asteroids require more shots to destroy)", "Upon Asteroid Destruction, do scores appear (larger numbers for bigger asteroids)", "Did you take damage (Health bar at the top of the screen, default 3 health)", "Did the Pause Menu Appear", "Does your ship travel relative to rotation, such that W is in the direction it faces"]
answers = []
