...
keys = ["Easy Selection Works", "Collision Works", "Return to menu works", "Scoring Works", "Start with same difficulty works"]
questions1 = ["Click Easy", "Press spacebar exectly once and watch the bat crash", "Upon Failing, Press Escape", "Select Any DIfficulty and Play the game",  "Upon Failing, Press Enter"]
questions2 = ["Does it say easy in the top left corner?", "Did you fail?", "Did you return to main menu", "Did your score go up by 1 for every gap you made it though", "Did the difficulty stay the same and you restarted"]
answers = []
