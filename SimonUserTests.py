...
keys = ["Computer Player Light Up Squares", "Human Player Lights Up Squares", "Order Stays Consistent Within Instance", "Loss on Time", "Loss on wrong square"]
questions1 = ["Play the Game", "Play the game", "Watch the order as you play the game", "Do not click any buttons and watch the time tick down", "Purposefully click a wrong square"]
questions2 = ["When the Computer sets the order, do you see the selected square get a lime highlight each time?", "When you select a square, does it gain a lime highlight?", "Click Yes if the order stays consistent with one exta at the end (Should change after you fail and retry)", "Did you fail?", "Did you fail?"]
