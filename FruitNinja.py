...
## THIS GAME IS NOT FULLY FUNCTIONAL. GAME NEVER ENDS NO MATTER HOW MANY BOMBS YOU HIT
## THE -10 BOMB CAN MAKE YOU GO NEGATIVE AND I HAVE NOT FIXED THAT YET
## PLAY ONLY TO TEST MECHANICS LIKE GRAVITY AND HITBOX DETECTION AND SLICING
## ALSO THE POWERUPS WORK AND HAVE A DISPLAYED TIMER. CHECK THAT IT WORKS
## UPDATES IN THE COMING DAYS WILL PREPARE GAME FOR FULL LAUNCH
root = tk.Tk()
