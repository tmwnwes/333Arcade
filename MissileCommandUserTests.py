...
keys = ["Cities and Batteries Exist", "Battery Cycling Works", "Pause Menu Appears", "Can Destroy Enemies", "Cities can be destroyed", "Scores pop up", "Batteries can be damaged and repaired"]
questions1 = ["Look at the bottom of your game screen", "Use left and right arrow keys and look at your missile batteries", "Press P", "Try to shoot down enemies. Shoot by clicking. (Travel time exists so you may need to lead your shots)", "Purposefully allow enemies to hit your cities directly (shots are random so it may take some time)", "Destroy some enemies", "Purposefully let an enemy hit one of your missile batteries"]
questions2 = ["Are there 6 cities and 3 large rectangular shapes (missile batteries) with text in them?", "Did a new battery get selected when using arrow keys. Selected battery is highlighted white","Did a pause screen appear", "Once your projectile or explosion hits an enemy, did it explode?", "Was a city destroyed (big bomb hit) or at least a building destroyed (small bomb hit)", "Did scores pop up and get added to your total score (top left)", "Did it become red and begin a repair countdown"]
