...
keys = ["Game Lost if Player Does Nothing", "Game Lost if Player clicks wrong colors alot", "Correct Colors Increase Score and Time"]
questions1 = ["Do Nothing and Watch the Clock Tick Down", "Click incorrect colors several times", "Click Correct Colors"]
questions2 = ["Did you Lose", "Did you Lose" , "Did score and/or time increase"]
answers = []
